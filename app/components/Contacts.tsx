...
export default function Contacts() {
  return (
    <div className='bg-gradient-to-br from-blue-50 to-blue-100'>
      <section id="contacts" className="flex items-center justify-center p-8">
      ...
      <footer className="py-6 text-right px-[4vw] flex flex-row justify-between items-center text-blue-700">
